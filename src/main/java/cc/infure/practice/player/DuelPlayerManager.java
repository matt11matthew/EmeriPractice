...
public class DuelPlayerManager {
    ...
    public boolean isPlayer(UUID uniqueId) {
        ...
        File file = new File(InfurePractice.getInstance().getDataFolder() + "/playerdata/", uniqueId.toString() + ".yml");
        if (file.exists()) {
    ...
    public AbstractDuelPlayer getDuelPlayer(String name) {
        ...
        File file = new File(InfurePractice.getInstance().getDataFolder() + "/playerdata/");
    ...
    public AbstractDuelPlayer create(UUID uuid, String username) {
        ...
        File file = new File(InfurePractice.getInstance().getDataFolder() + "/playerdata/", uuid.toString() + ".yml");
        if (file.exists()) {
            FileConfiguration configuration = YamlConfiguration.loadConfiguration(file);
        ...
        for (GameType gameType : GameType.values()) {
            if (Arrays.asList(GameType.getRankedGames()).contains(gameType)) {
                abstractDuelPlayer.setElo(gameType, new Value<>(InfurePractice.getInstance().getDuelsConfig().getInteger("defaultElo"), ValueType.SET));
            }
