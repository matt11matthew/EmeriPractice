package net.emeri.practice.config;
...
public class Config {
    ...
    public Config(String name) {
        this.configurationFile = new File(EmeriPractice.getInstance().getDataFolder() + "/" + name + ".yml");
        ...
        if (!this.configurationFile.exists()) {
            try {
                ...
                InputStream inputStream = EmeriPractice.getInstance().getResource(name + ".yml");
                if (inputStream != null) {
